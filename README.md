...
알겠습니다. 요청하신 **④ 분석 – 연령대별·사고원인별 특성 분석(화물차)** 형식으로,
앞에서 보여주신 **지도·다발지역·시도별 사고 분포 결과를 자연스럽게 반영**해서 정리해 드리겠습니다.

---

## 📊 ④ 분석 – 연령대별·사고 원인별 **화물차 사고 특성 분석**

### 🔍 분석 질문

**어떤 연령대의 화물차 운전자에게서, 어떤 사고 원인이 두드러지는가?**
<img width="1608" height="572" alt="image" src="https://github.com/user-attachments/assets/dfcb2fe9-66af-497f-9e31-78a808c55563" />
...
* **전 연령대 공통**
  ...
  * ‘**안전운전 의무 불이행**’이 가장 높은 사고 원인
  * 장시간 운전, 피로 누적, 과속·차로 미준수 등 **업무 특성에 따른 위험 요인**이 구조적으로 존재

* **30~50대 화물차 운전자**

  * 전체 화물차 사고의 **가장 큰 비중 차지**
  * 사고 다발 지역(산업단지 인근, 도심 주요 교차로, 물류 거점)과 **공간적으로 일치**
  * 신호위반, 안전거리 미확보, 교차로 사고 빈도 높음
    → **업무 압박 + 운행 빈도 증가**가 주요 원인으로 추정

* **20~40대**

  * 상대적으로 **신호위반, 중앙선 침범, 차로 위반 등 복합 위반 비율 높음**
  * 도심·수도권 사고 집중 현상과 연계
    → **운전 숙련도 대비 업무 강도 불균형 가능성**

* **60대 이상**

  * 사고 건수는 상대적으로 적으나
  * **단일 사고 시 중대 사고로 이어질 가능성** 존재
    → 반응 속도 저하, 야간·새벽 운전 취약
...
* 화물차 사고는 단순히 “개인 음주·과속 문제”가 아니라
  **연령대별 운전 행태 + 업무 환경 + 공간적 요인**이 복합적으로 작용

  * 🚨 **연령대별 맞춤형 안전 교육**
  * 🕒 **운행 시간·휴식 관리 강화**
  * 🛣️ **사고 다발 지역 중심의 구조 개선 및 단속**
